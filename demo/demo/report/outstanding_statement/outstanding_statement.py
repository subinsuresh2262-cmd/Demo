...
def get_columns():
    return [
        ...
        {"label": _("Ref"), "fieldname": "voucher_no", "fieldtype": "Dynamic Link", "options": "voucher_type", "width": 180},
        {"label": _("Description"), "fieldname": "description", "fieldtype": "Data", "width": 260},
        {"label": _("LPO Number"), "fieldname": "po_no", "fieldtype": "Data", "width": 140},
        ...
        {"label": _("Voucher Type"), "fieldname": "voucher_type", "fieldtype": "Data", "hidden": 1, "width": 120},
    ]
